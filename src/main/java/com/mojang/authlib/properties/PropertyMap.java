...
extends ForwardingMultimap<String, Property> {
    ...
    implements JsonSerializer<PropertyMap>, JsonDeserializer<PropertyMap> {
        @Override public PropertyMap deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            if (json instanceof JsonObject) {
                ...
                for (JsonElement element : (JsonArray) json) {
                    if (element instanceof JsonObject) {
                        ...
                        result.put(name, object.has("signature") ?
        ...
        @Override public JsonElement serialize(PropertyMap src, Type typeOfSrc, JsonSerializationContext context) {
