...
extends HttpAuthenticationService {
    ...
    @Override public LegacyUserAuthentication createUserAuthentication(Agent agent) {
    ...
    @Override public LegacyMinecraftSessionService createMinecraftSessionService() {
